package com.dwommack.PressTheRedButton.robovm;
...
public class PressTheRedButtonRoboVM extends UIApplicationDelegateAdapter {
  ...
  public static void main (String[] args) {
    ...
    UIApplication.main(args, null, PressTheRedButtonRoboVM.class);
    pool.close();
  }
}
